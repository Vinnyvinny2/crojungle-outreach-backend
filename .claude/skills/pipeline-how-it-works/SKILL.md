...
now (2026-09-09): - `server.js` — ~84,100 lines … GENERATED from `src/` by `build.js` — measured: at Round 128 the built file was A2_NUMBERS lines, the same count as `src/all.js` (`node build.js --check` prints the current count)
