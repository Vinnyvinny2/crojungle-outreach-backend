      ...
      // the render where nothing could run them.
      {
        ...
        // ══ ROUND 105: THE FIND TAB REMEMBERS, AND NOTHING-TO-READ IS ITS OWN STATE ══
        {
          ...
          // and the button count all read ONE rule.
          {
            ...
            const _lastRow = { name: 'Chain Branch Co', contactReadOk: true, contactOwner: 'Ron Branch', contactPhone: '5550009999', contactIcp: 90, contactLanes: { call: true, email: true, noname: false, last: true }, contactLayers: 'layered' };
            const _firstRow = { name: 'Darrel Two', contactReadOk: true, contactOwner: 'Darrel Two', contactPhone: '5550008888', contactIcp: 40, contactLanes: { call: true, email: false, noname: false, last: false } };
