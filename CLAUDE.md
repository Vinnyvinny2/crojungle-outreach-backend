...
- 191 boot checks at the bottom, each documenting the live failure that caused it
...
PORT=4000 timeout 420 node --max-old-space-size=256 server.js   # 191 boot checks
...
and caused none of this week's failures. The 191 boot checks and the comments above
